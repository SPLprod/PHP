...
<body>
    ...
    */
        ...
        (isset($_GET["langue"]) && !empty($_GET["langue"])) ? setcookie("langue", $_GET["langue"], time() + 365 *24 *60 *60) : "";
    ...
    echo (isset($_GET["langue"]) && !empty($_GET["langue"])) ? "<h1>Le site est traduit en : " . $_GET["langue"] . "</h1>" : "<h1>Le site est traduit en : fr</h1>";
    echo "</div>";
    ...
    <div class="language-selection">
        ...
        <ul>
            ...
            <li><a href="lingua_it.php?langue=it">Italien</a></li>
